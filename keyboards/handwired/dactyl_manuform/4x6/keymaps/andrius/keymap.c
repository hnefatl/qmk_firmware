 ...
 */
[LAYER_RAISE] = LAYOUT(
    _______,XXXXXXX,XXXXXXX,S(KC_1),S(KC_6),XXXXXXX,            KC_LCBR,KC_RCBR,KC_LABK,KC_RABK,XXXXXXX,XXXXXXX,   \
    _______,S(KC_2),S(KC_8),S(KC_4),S(KC_5),S(KC_7),            S(KC_9),S(KC_0),KC_LABK,KC_RABK,XXXXXXX,XXXXXXX,  \
